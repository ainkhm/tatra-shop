                ...
                <Form className="flex flex-col text-[#C9C9C9] gap-4">
                    <div className="form-group flex flex-col gap-4">
                        <Field
                            type="text"
                            name="firstname"
                            className="form-control w-[100%] h-[40px] bg-[#ffffff]  text-[12px] border-[1px] border-[#C9C9C9] pl-4  "
                            placeholder="First name*"
                        />
                        <Field
                            type="text"
                            name="lastname"
                            className="form-control w-[100%] h-[40px] text-[12px] bg-[#ffffff] border-[1px] border-[#C9C9C9] pl-4  "
                    ...
                    <div className="form-group flex flex-col lg:flex-row  gap-3">
                        <Field
                            type="text"
                            name="street"
                            className="form-control w-[100%] lg:w-[50%] bg-[#ffffff] h-[40px] text-[12px] border-[1px] border-[#C9C9C9] pl-4  "
                            placeholder="STREET*"
                        />
                        <Field
                            type="text"
                    ...
                    <div className="form-group flex flex-col lg:flex-row  gap-3">
                        <Field
                            type="text"
                            name="postcode"
                            className="form-control w-[100%] lg:w-[50%] h-[40px] bg-[#ffffff] text-[12px] border-[1px] border-[#C9C9C9] pl-4  "
                    ...
                    <div className="form-group">
                        <Field
                            as="select"
                            name="color"
                            className="form-control w-[100%] bg-[#ffffff] text-[#aeaaaa] h-[40px] text-[12px] border-[1px] border-[#C9C9C9] pl-4"
                        >
                    ...
                    <div className="form-group flex flex-col gap-3">
                        <Field
                            type="text"
                            name="email"
                            className="form-control w-[100%] bg-[#ffffff]  h-[40px] text-[12px]  border-[1px] border-[#C9C9C9] pl-4  "
                            placeholder="EMAIL"
                        />
                        <Field
                            type="text"
                        ...
                        <Field
                            type="text"
                            name="Phone"
                            className="form-control w-[100%] h-[50px] bg-[#ffffff] text-[12px]  border-[1px] border-[#C9C9C9] pl-4  "
